...
<head>
  ...
  <title>Riyanshi Computer बलुआ, सीतामढ़ी - CSC केंद्र और डिजिटल सेवाएं</title>
  ...
  <meta property="og:url" content="https://www.riyanshicomputer.in/" />
...
#welcome, #clock, #date, .typing-text {
  margin-top: 10px;
}
...
<button onclick="toggleMusic()">🎵 म्यूज़िक चालू/बंद</button>
  <div class="gallery">
    ...
    <img src="img3.gif" alt="Riyanshi Computer Digital Services" />
